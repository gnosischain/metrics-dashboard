const metric = {
  ...
  name: 'Active',
  description: 'Validators currently active under this credential',
  metricDescription: 'Count of validators with status in (active_ongoing, active_exiting, active_slashed).',
  format: 'formatNumber',
