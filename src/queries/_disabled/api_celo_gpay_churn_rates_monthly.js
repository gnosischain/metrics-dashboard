const metric = {
  id: 'api_celo_gpay_churn_rates_monthly',
  name: 'Churn and Retention Rates',
  description: 'Monthly lifecycle rates',
  metricDescription: `
  Monthly churn and retention rates

  - __Churn rate:__ percentage of current month active Safes who are not active the following month
  - __Retention rate:__ percentage of the previous month active Safes who remain active in the current month
