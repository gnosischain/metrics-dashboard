...
const metric = {
  ...
  columns: [
    ...
    { field: 'address_type', title: 'Type', width: 120 },
    { field: 'wallet_age_date', title: 'Wallet age', sorter: 'datetime', formatter: (cell) => formatDate(cell.getValue()) },
    { field: 'safe_creation_date', title: 'Safe deployed', sorter: 'datetime', formatter: (cell) => formatDate(cell.getValue()) },
