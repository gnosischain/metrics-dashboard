const metric = {
  id: 'api_celo_gpay_retention_by_action_monthly',
  name: 'Retention by Action',
  description: 'Cohort heatmap by first action month',
  metricDescription: 'Cohort retention heatmap by action type (Payment, Top-up, Withdrawal, Reversal). Filter action and switch between users/volume views.',
  chartType: 'heatmap',
  xField: 'x',
  yField: 'y',
  ...
  query: `
    ...
    FROM dbt.api_celo_gpay_retention_by_action_monthly
    ORDER BY
